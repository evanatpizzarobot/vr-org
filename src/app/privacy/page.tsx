  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-[15px] leading-[1.7] mb-4" style={{ color: "var(--text-secondary)" }}>
          VR.org participates in the Amazon Services LLC Associates Program. When you click on Amazon product links on our{" "}
        ...
        <ul className="text-[15px] leading-[1.7] mb-8 list-disc pl-6 flex flex-col gap-1" style={{ color: "var(--text-secondary)" }}>
          ...
          <li>
            <strong style={{ color: "var(--text-primary)" }}>Affiliate networks:</strong> Amazon Associates, linked from our /deals page.
          </li>
        </ul>
