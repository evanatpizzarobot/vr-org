// MCP prompt templates for the VR.org remote endpoint (/mcp). Reusable prompts a
// user can invoke that steer the model to answer using VR.org's tools and
// resources. Kept identical to the npm package's src/prompts.ts.

import { sanitizeReflectedValue } from "./tools";
